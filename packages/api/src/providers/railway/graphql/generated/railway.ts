...
export enum ActiveFeatureFlag {
  ...
  CdnCaching = "CDN_CACHING",
  DebugSmartDiagnosis = "DEBUG_SMART_DIAGNOSIS",
  Ipv6Egress = "IPV6_EGRESS",
  MagicConfig = "MAGIC_CONFIG",
  PostgresPgbouncer = "POSTGRES_PGBOUNCER",
  PriorityBoarding = "PRIORITY_BOARDING",
  SmartDiagnosis = "SMART_DIAGNOSIS",
  UnlimitedSmartDiagnosis = "UNLIMITED_SMART_DIAGNOSIS",
}

export enum ActivePlatformFlag {
  AllowReplicaMetrics = "ALLOW_REPLICA_METRICS",
  ArchiverV2Rollout = "ARCHIVER_V2_ROLLOUT",
  ...
  CompareClickhouseMetrics = "COMPARE_CLICKHOUSE_METRICS",
  CtrdImageStoreRollout = "CTRD_IMAGE_STORE_ROLLOUT",
  DemoPercentageRollout = "DEMO_PERCENTAGE_ROLLOUT",
  DisableOauthAccessTokens = "DISABLE_OAUTH_ACCESS_TOKENS",
  EnableRawSqlQueries = "ENABLE_RAW_SQL_QUERIES",
  FocusedPrEnvironments = "FOCUSED_PR_ENVIRONMENTS",
  NewStripeWebhookVersionRollout = "NEW_STRIPE_WEBHOOK_VERSION_ROLLOUT",
  OauthDcrKillswitch = "OAUTH_DCR_KILLSWITCH",
  OauthDeviceFlowKillswitch = "OAUTH_DEVICE_FLOW_KILLSWITCH",
  ServiceinstanceDataloaderForStaticUrl = "SERVICEINSTANCE_DATALOADER_FOR_STATIC_URL",
  SplitUsageQueries = "SPLIT_USAGE_QUERIES",
  UnifiedSnapshotAndBuild = "UNIFIED_SNAPSHOT_AND_BUILD",
  UnifiedSnapshotAndBuildHobby = "UNIFIED_SNAPSHOT_AND_BUILD_HOBBY",
  UpdatedVmQueries = "UPDATED_VM_QUERIES",
  UseClickhouseMetrics = "USE_CLICKHOUSE_METRICS",
  UseGhWebhooksForChangeDetection = "USE_GH_WEBHOOKS_FOR_CHANGE_DETECTION",
  VmTimeRangeQuery = "VM_TIME_RANGE_QUERY",
}

export enum ActiveProjectFeatureFlag {
...
export enum CustomDomainSyncStatus {
  Active = "ACTIVE",
  Creating = "CREATING",
  Deleted = "DELETED",
  Deleting = "DELETING",
...
export enum PartnerProfileType {
  BasicPartner = "BASIC_PARTNER",
  LimitedPartner = "LIMITED_PARTNER",
  TemplateMaintainer = "TEMPLATE_MAINTAINER",
}
...
export enum PrivateNetworkEndpointSyncStatus {
  Active = "ACTIVE",
  Creating = "CREATING",
  Deleted = "DELETED",
  Deleting = "DELETING",
...
export enum ServiceDomainSyncStatus {
  Active = "ACTIVE",
  Creating = "CREATING",
  Deleted = "DELETED",
  Deleting = "DELETING",
...
export enum TcpProxySyncStatus {
  Active = "ACTIVE",
  Creating = "CREATING",
  Deleted = "DELETED",
  Deleting = "DELETING",
...
export enum TrustedDomainStatus {
  Failed = "FAILED",
  Pending = "PENDING",
  Verified = "VERIFIED",
}
...
export enum TwoFactorMethodCompliance {
  Authenticator = "AUTHENTICATOR",
  Passkey = "PASSKEY",
}

export enum TwoFactorMethodProjectWorkspace {
  Authenticator = "AUTHENTICATOR",
  Passkey = "PASSKEY",
}
...
export enum WorkspaceIdPConnectionStatus {
  Active = "ACTIVE",
  Draft = "DRAFT",
  Inactive = "INACTIVE",
  Pending = "PENDING",
...
export enum WorkspacePolicyName {
  RestrictPublicTcpProxies = "RESTRICT_PUBLIC_TCP_PROXIES",
  RestrictRailwayDomainGeneration = "RESTRICT_RAILWAY_DOMAIN_GENERATION",
}
...
export type GetPrivateNetworkEndpointQueryVariables = Exact<{
  environmentId: Scalars["String"]["input"];
  privateNetworkId: Scalars["String"]["input"];
  serviceId: Scalars["String"]["input"];
}>;

export type GetPrivateNetworkEndpointQuery = {
  __typename?: "Query";
  privateNetworkEndpoint?: { __typename?: "PrivateNetworkEndpoint"; dnsName: string } | null;
};

export type GetProjectPrivateNetworkIdQueryVariables = Exact<{
  environmentId: Scalars["String"]["input"];
}>;

export type GetProjectPrivateNetworkIdQuery = {
  __typename?: "Query";
  privateNetworks: Array<{ __typename?: "PrivateNetwork"; publicId: string }>;
};
        ...
        edges: Array<{
          ...
          node: {
            ...
            deployments: {
              ...
              edges: Array<{
                __typename?: "EnvironmentDeploymentsConnectionEdge";
                node: { __typename?: "Deployment"; id: string; status: DeploymentStatus };
              }>;
            };
          };
        }>;
...
export type DeploymentRedeployMutation = {
  __typename?: "Mutation";
  deploymentRedeploy: {
    __typename?: "Deployment";
    id: string;
...
export type ServiceInstanceDeployMutationVariables = Exact<{
  environmentId: Scalars["String"]["input"];
  serviceId: Scalars["String"]["input"];
  latestCommit: Scalars["Boolean"]["input"];
}>;

export type ServiceInstanceDeployMutation = {
  __typename?: "Mutation";
...
export type VolumeCreateMutation = {
  __typename?: "Mutation";
  volumeCreate: { __typename?: "Volume"; id: string; name: string; createdAt: any };
};
...
export type ServiceDomainCreateMutation = {
  __typename?: "Mutation";
  serviceDomainCreate: { __typename?: "ServiceDomain"; id: string; domain: string };
};
...
export type TcpProxyCreateMutation = {
  __typename?: "Mutation";
  tcpProxyCreate: {
    __typename?: "TCPProxy";
    id: string;
...
export const ServiceDocument = `
  ...
  service(id: $id) {
    ...
    `;
export const GetPrivateNetworkEndpointDocument = `
  ...
  privateNetworkEndpoint(
    ...
    `;
export const GetProjectPrivateNetworkIdDocument = `
    query GetProjectPrivateNetworkId($environmentId: String!) {
  privateNetworks(environmentId: $environmentId) {
    publicId
  }
}
    `;
export const ServiceCreateDocument = `
...
export const ServiceInstanceUpdateDocument = `
    mutation serviceInstanceUpdate($environmentId: String!, $serviceId: String!, $image: String!, $multiRegionConfig: JSON!) {
  serviceInstanceUpdate(
    ...
    `;
export const ServiceInstanceDeployDocument = `
    mutation serviceInstanceDeploy($environmentId: String!, $serviceId: String!, $latestCommit: Boolean!) {
...
export const TcpProxyCreateDocument = `
    mutation TcpProxyCreate($applicationPort: Int!, $environmentId: String!, $serviceId: String!) {
  tcpProxyCreate(
    input: {applicationPort: $applicationPort, environmentId: $environmentId, serviceId: $serviceId}
  ) {
    id
    domain
    proxyPort
    ...
    `;
export const TcpProxyDeleteDocument = `
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    Service(variables: ServiceQueryVariables, options?: C): Promise<ServiceQuery> {
      return requester<ServiceQuery, ServiceQueryVariables>(
        ServiceDocument,
        variables,
        options,
      ) as Promise<ServiceQuery>;
    },
    GetPrivateNetworkEndpoint(
      variables: GetPrivateNetworkEndpointQueryVariables,
      options?: C,
    ): Promise<GetPrivateNetworkEndpointQuery> {
      return requester<GetPrivateNetworkEndpointQuery, GetPrivateNetworkEndpointQueryVariables>(
        GetPrivateNetworkEndpointDocument,
        variables,
        options,
      ) as Promise<GetPrivateNetworkEndpointQuery>;
    },
    GetProjectPrivateNetworkId(
      variables: GetProjectPrivateNetworkIdQueryVariables,
      options?: C,
    ): Promise<GetProjectPrivateNetworkIdQuery> {
      return requester<GetProjectPrivateNetworkIdQuery, GetProjectPrivateNetworkIdQueryVariables>(
        GetProjectPrivateNetworkIdDocument,
        variables,
        options,
      ) as Promise<GetProjectPrivateNetworkIdQuery>;
    },
    ServiceCreate(
      variables: ServiceCreateMutationVariables,
      options?: C,
    ): Promise<ServiceCreateMutation> {
      return requester<ServiceCreateMutation, ServiceCreateMutationVariables>(
        ServiceCreateDocument,
        variables,
        options,
      ) as Promise<ServiceCreateMutation>;
    },
    ServiceDelete(
      variables: ServiceDeleteMutationVariables,
      options?: C,
    ): Promise<ServiceDeleteMutation> {
      return requester<ServiceDeleteMutation, ServiceDeleteMutationVariables>(
        ServiceDeleteDocument,
        variables,
        options,
      ) as Promise<ServiceDeleteMutation>;
    },
    DeploymentRedeploy(
      variables: DeploymentRedeployMutationVariables,
      options?: C,
    ): Promise<DeploymentRedeployMutation> {
      return requester<DeploymentRedeployMutation, DeploymentRedeployMutationVariables>(
    ...
    DeploymentRemove(
      ...
      return requester<DeploymentRemoveMutation, DeploymentRemoveMutationVariables>(
        DeploymentRemoveDocument,
        variables,
        options,
      ) as Promise<DeploymentRemoveMutation>;
    },
    serviceInstanceUpdate(
      variables: ServiceInstanceUpdateMutationVariables,
      options?: C,
    ): Promise<ServiceInstanceUpdateMutation> {
      return requester<ServiceInstanceUpdateMutation, ServiceInstanceUpdateMutationVariables>(
        ServiceInstanceUpdateDocument,
        variables,
        options,
      ) as Promise<ServiceInstanceUpdateMutation>;
    },
    serviceInstanceDeploy(
      variables: ServiceInstanceDeployMutationVariables,
      options?: C,
    ): Promise<ServiceInstanceDeployMutation> {
      return requester<ServiceInstanceDeployMutation, ServiceInstanceDeployMutationVariables>(
        ServiceInstanceDeployDocument,
        variables,
        options,
      ) as Promise<ServiceInstanceDeployMutation>;
    },
    VolumeCreate(
      variables: VolumeCreateMutationVariables,
      options?: C,
    ): Promise<VolumeCreateMutation> {
      return requester<VolumeCreateMutation, VolumeCreateMutationVariables>(
        VolumeCreateDocument,
        variables,
        options,
      ) as Promise<VolumeCreateMutation>;
    },
    VolumeDelete(
      variables: VolumeDeleteMutationVariables,
      options?: C,
    ): Promise<VolumeDeleteMutation> {
      return requester<VolumeDeleteMutation, VolumeDeleteMutationVariables>(
        VolumeDeleteDocument,
        variables,
        options,
      ) as Promise<VolumeDeleteMutation>;
    },
    ServiceDomainCreate(
      variables: ServiceDomainCreateMutationVariables,
      options?: C,
    ): Promise<ServiceDomainCreateMutation> {
      return requester<ServiceDomainCreateMutation, ServiceDomainCreateMutationVariables>(
        ServiceDomainCreateDocument,
        variables,
        options,
      ) as Promise<ServiceDomainCreateMutation>;
    },
    ServiceDomainDelete(
      variables: ServiceDomainDeleteMutationVariables,
      options?: C,
    ): Promise<ServiceDomainDeleteMutation> {
      return requester<ServiceDomainDeleteMutation, ServiceDomainDeleteMutationVariables>(
        ServiceDomainDeleteDocument,
        variables,
        options,
      ) as Promise<ServiceDomainDeleteMutation>;
    },
    TcpProxyCreate(
      variables: TcpProxyCreateMutationVariables,
      options?: C,
    ): Promise<TcpProxyCreateMutation> {
      return requester<TcpProxyCreateMutation, TcpProxyCreateMutationVariables>(
        TcpProxyCreateDocument,
        variables,
        options,
      ) as Promise<TcpProxyCreateMutation>;
    },
    TcpProxyDelete(
      variables: TcpProxyDeleteMutationVariables,
      options?: C,
    ): Promise<TcpProxyDeleteMutation> {
      return requester<TcpProxyDeleteMutation, TcpProxyDeleteMutationVariables>(
        TcpProxyDeleteDocument,
        variables,
        options,
      ) as Promise<TcpProxyDeleteMutation>;
    },
  };
}
