        ...
        <article className="prose-policy mt-10 space-y-10 text-[15px] leading-relaxed text-white/75">
          <section className="space-y-3">
            <p>
              ...
              when you use the hosted GitTerm service at gitterm.dev, how we use it, and the choices
              you have. If you self-host GitTerm, this policy does not apply. You are the data
          ...
          <Section title="1. Who we are">
            <p>
              GitTerm provides cloud workspaces for running coding agents. The hosted service is
              operated by the GitTerm maintainers. You can reach us at{" "}
          ...
          <Section title="6. Sharing and processors">
            <p>
              We share data only with vetted processors who help us run GitTerm. These include cloud
              hosting and compute providers, our database and cache providers, our authentication
              system, our payments processor, our email provider, and our analytics provider if you
              consent. Each processor is bound by a data processing agreement and may only use your
              data to provide services to us.
            </p>
            <p>
              We may disclose information if required to do so by law, to protect our rights, or to
          ...
          <Section title="8. International transfers">
            <p>
              Our infrastructure may process data in regions outside your country of residence.
          ...
          <Section title="9. Your rights">
            ...
            <p>
              You can exercise most of these rights directly from the dashboard or by emailing{" "}
              <a className="text-primary underline" href="mailto:help@gitterm.dev">
                help@gitterm.dev
              </a>
              .
          ...
          <Section title="10. Security">
            <p>
              We use industry-standard measures including TLS in transit, encryption at rest where
              supported, scoped access controls, and regular dependency updates. No system is
          ...
          <Section title="11. Children">
            <p>
              GitTerm is not directed to children under 13 (or the equivalent age of digital consent
          ...
          <Section title="12. Changes to this policy">
            <p>
              ...
              updating the "Last updated" date above and, where appropriate, by a notice in the app.
            </p>
          </Section>
