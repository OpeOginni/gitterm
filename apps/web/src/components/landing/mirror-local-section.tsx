...
export function MirrorLocalSection() {
  return (
    <section id="opencode-sync" className="border-t border-line py-24 md:py-32">
      <div className="mx-auto max-w-[1120px] px-6">
        <div className="grid gap-12 lg:grid-cols-[1fr_1.2fr] lg:items-center">
          ...
          <div>
            ...
            <p className="text-base leading-relaxed text-fg-3 sm:text-lg">
          ...
          <div className="overflow-hidden rounded-2xl border border-line bg-fill">
            ...
            <div className="divide-y divide-line">
              {profileItems.map((item) => (
                <div
                  key={item.label}
                  className="flex items-center gap-4 px-6 py-5 transition-colors hover:bg-fill"
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-0.5 text-[13px] leading-snug text-fg-4">{item.detail}</p>
                  </div>
